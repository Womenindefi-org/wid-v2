    ...
    <>
      <HeroV2 bgUrl="programs-hero-img.png">
        ...
        <p className="text-white leading-5 md:leading-8 font-normal text-[0.75rem] md:text-[1rem] max-w-full md:max-w-260 mx-auto text-center">
          ...
          broader tech industry? Your experience is invaluable. Mentoring is the
          most direct way to accelerate the careers of aspiring women who are
          ready to build, but just need a guiding voice.
        </p>
      </HeroV2>
        ...
        <div className="max-w-350 flex flex-col md:flex-col-reverse lg:flex-row gap-6 md:gap-10 items-start mx-auto">
          ...
          <div className="flex-1 w-full">
            ...
            >
              ...
              dedicated to supporting African women pursuing careers in Web3.
              This initiative provides an opportunity to develop leadership and
              coaching skills while creating a lasting impact on the next
              generation of women in Web3. Mentors will be recognized publicly
              and awarded a certificate of contribution. We are seeking mid- to
              senior-level professionals with at least three years of experience
              in any of our program tracks, who are committed to active
              participation and comfortable with virtual mentorship and
              communication.
            </p>
            <Button
              url="https://forms.gle/Vfj7Mrc4hqTsD8SLA"
