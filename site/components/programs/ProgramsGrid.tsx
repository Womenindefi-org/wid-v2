      ...
      <div className="max-w-350 mx-auto">
          ...
          {[
            {
              ...
              url: "https://forms.gle/FBXfMzAcjENzJ4Eg6",
            },
            {
            ...
            >
              <figure
                style={{
                  backgroundImage: `url(/images/about-img-${index + 2}.png)`,
                }}
        ...
        >
          ...
          <div className="p-[1rem_.75rem] md:p-[1.5rem_1.125rem] items-center flex-col flex gap-1">
            ...
            >
              This is an all-encompassing 3-4 months educational initiative
              tailored to equip women with the knowledge and skills needed to
              thrive in the Web3 technology landscape. It offers a unique
              opportunity to not only acquire essential technical skills but
              also to harness Web3 to address pressing socio-economic challenges
              across Africa. The training covers tracks across Blockchain
              Development, Product Design, Product Management, Project
              Management, Community Management, Technical Writing and Advanced
